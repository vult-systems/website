...
heroImage: "src/assets/halo-infinite/343i-chimera-armor-06.png"
order: 1
size: "small"
---
...
<Image src={logo343} alt="343 Industries Logo" class="rounded-md border border-border my-8" />

## Technical Details

<Image src={armor04} alt="Chimera Armor - Side View" class="rounded-md border border-border my-8" />
...
<Image src={armor02} alt="Chimera Armor - Detail View" class="rounded-md border border-border my-8" />
...
<Image src={armor03} alt="Chimera Armor - Alternate Angle" class="rounded-md border border-border my-8" />
