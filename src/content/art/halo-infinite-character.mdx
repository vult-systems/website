...
<Image src={logo343} alt="343 Industries Logo" class="rounded-lg border border-border my-8" />

## Technical Details

<Image src={armor04} alt="Chimera Armor - Side View" class="rounded-lg border border-border my-8" />
...
<Image src={armor02} alt="Chimera Armor - Detail View" class="rounded-lg border border-border my-8" />
...
<Image src={armor03} alt="Chimera Armor - Alternate Angle" class="rounded-lg border border-border my-8" />
